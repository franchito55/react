...
export function Tile({ index, value = 0, updateBoard }) {
    ...
    if (value === 0) {
        svgCrossClassName = ' displayNone';
        svgCircleClassName = ' displayNone';
    } else if (value === 1) {
        svgCrossClassName = '';
        svgCircleClassName = ' displayNone';
    } else {
